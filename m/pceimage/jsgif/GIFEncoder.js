...
GIFEncoder = function() {
	...
	var addFrame = exports.addFrame = function addFrame(im, is_imageData) {
		...
		try {
			...
			console.log("GIFEncoder:addFrame hit exception: " + e)
			ok = false;
		}
	...
	*/
	...
	var analyzePixels = function analyzePixels() {
      ...
      // MEMALIGN: Applying the fix for transparency from https://github.com/antimatter15/jsgif/issues/3#issuecomment-11648023
